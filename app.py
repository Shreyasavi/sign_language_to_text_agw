...
class Application:
    def __init__(self):
        ...
        self.json_file_smn = open("model-bw_agw.json" , "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights("model-bw_agw.h5")
    ...
    def predict(self,test_image):
        ...
        result_agw = self.loaded_model_smn.predict(test_image.reshape(1 , 128 , 128 , 1))
        prediction={}
        ...
        if(self.current_symbol == 'M' or self.current_symbol == 'N' or self.current_symbol == 'S'):
        	prediction1 = {}
        	prediction1['A'] = result_agw[0][0]
        	prediction1['G'] = result_agw[0][1]
        	prediction1['W'] = result_agw[0][2]
